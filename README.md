...
Flask — это микро веб-фреймворк с открытым исходным кодом, дружелюбный к новичкам, написанный на Python, который следует архитектурному шаблону MVC (модель-представление-контроллер) и поддерживает шаблоны Jinja, которые можно использовать для создания представлений. На нём можно сделать и лендинг, и многостраничный сайт с кучей плагинов и сервисов. Не фреймворк, а мечта!
...
Для запуска сайта необходимо перейти в корневой каталог сайта Flask и в командной строке  запустить команду :
...
![](https://github.com/stels24/-Help/blob/main/Добавление%20задачи%20Fastapi.png)
 ...
 ![](https://github.com/stels24/-Help/blob/main/Дашборд%20fastapi.png)        
 ![](https://github.com/stels24/-Help/blob/main/Регистрация%20пользователя%20Fastapi.png)
 ![](https://github.com/stels24/-Help/blob/main/Регистрация%20пользователя%20Fastapi%201.png)
...
3. Добавлены комментарии в формате docstring в необходимые файлы созданных приложений.
